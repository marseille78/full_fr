...
(% Je vais insérer un document dans le dossier. )  
(% Insérez la clé dans la serrure. )  
(% Il faut insérer les informations dans le formulaire. ) --- (Дієслова робочий операцій; A2)

вставляти

(Включати або додавати щось у певне місце.)

(% Я вставлю документ у папку. )  
(% Вставте ключ у замок. )  
(% Треба вставити інформацію у форму. )  
...
(% Il a dû amputer sa jambe après l'accident. )  
(% Les médecins ont décidé d'amputer la zone infectée. )  
(% Ils ont amptué l'arbre de ses branches mortes. ) --- (Дієслова робочий операцій; B2)

відрізати  
ампутувати

(Позначає видалення частини тіла або об'єкта для лікування або відновлення.)

(% Йому довелося ампутувати ногу після аварії. )  
(% Лікарі вирішили ампутувати заражену ділянку. )  
(% Вони обрізали дерево від мертвих гілок. )
